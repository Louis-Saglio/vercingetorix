...
- **Buildings:** the set of buildings a civ owns is the buildable-structure closure of `generic_buildings/` (builder lists with `{civ}` substitution and template existence).
