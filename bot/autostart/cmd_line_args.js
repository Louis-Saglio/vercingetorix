 ...
 *
 * Vercingetorix override of the public mod's file: identical except that
 * treasures are always disabled in experiments (no random treasure
 * windfalls influencing results).
